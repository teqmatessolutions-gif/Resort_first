...
-- Insert food categories first
INSERT INTO food_categories (name, description) VALUES 
('Breakfast', 'Morning meals and continental breakfast'),
('Lunch', 'Afternoon meals and main courses'),
('Dinner', 'Evening meals and fine dining'),
